...
{
    public partial class frmAddUsersToUserGroups : Form
    {
        ...
        private void frmAddUsersToUserGroups_Load(object sender, EventArgs e)
        {
        ...
        public frmAddUsersToUserGroups()
        {
            InitializeComponent();
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            DataProcessingMethods.InsertUserGroupMembers(userGroupMembersToLoad, txtChangeDesc.Text,filename, progressBar1,chkAudit);
